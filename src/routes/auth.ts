...
import { register, verifyNumber, regenerateVerificationCode, uploadImage, completeProfile, login, sendResetCode, verififyResetCode, resetPassword } from "../controllers/auth-controllers";
